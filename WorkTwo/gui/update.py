...
class Login(tk.Tk):
    ...
    def setup_UI(self):
        ...
        tk.Button(page, text="查询", font=20, width=6, command=self.ok).grid(row=4, column=1, pady=10, sticky=tk.N)
    ...
    def setup_UI2(self,student:Stu) :
        ...
        tk.Button(page, text="返回", font=20, width=6, command=self.returns).grid(row=9, column=2, pady=10)
